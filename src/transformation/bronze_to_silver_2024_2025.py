...
def normalize_column_name(name):
    ...
    # Evita nomes de colunas começando com números
...
for field in df.schema.fields:
    ...
    if isinstance(field.dataType, StringType):
        ...
        # Converte representações textuais de ausência em NULL
        df = df.withColumn(
            col_name,
            F.when(
                F.lower(
...
# A deduplicação ocorre após a limpeza textual.
# Assim, registros diferentes apenas por espaços ou
# representações inconsistentes de nulos também são tratados.
...
print("==============================================")
print("SCHEMA FINAL DA SILVER - 2024-2025")
df.printSchema()
print("==============================================")
...
print("==============================================")
print("CAMADA SILVER 2024-2025 GERADA COM SUCESSO")
